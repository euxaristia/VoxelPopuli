...
The renderer takes inspiration from Microsoft's [Vibrant Visuals lighting](https://learn.microsoft.com/en-us/minecraft/creator/documents/vibrantvisuals/lightingcustomization?view=minecraft-bedrock-stable), [atmosphere](https://learn.microsoft.com/en-us/minecraft/creator/documents/vibrantvisuals/atmosphericscustomization?view=minecraft-bedrock-stable), and [water](https://learn.microsoft.com/en-us/minecraft/creator/documents/vibrantvisuals/watercustomization?view=minecraft-bedrock-stable) documentation. It remains a custom implementation: shadow maps, screen-space reflections, volumetric light shafts, and particle-concentration water settings are not implemented. Haze is an analytic approximation; water reflection samples the sky color rather than nearby geometry.
